...
10.times do
    tag = Tag.create(title: Faker::TvShows::BreakingBad.character)
end
...
15.times do 
	private_message = PrivateMessage.create(content: Faker::TvShows::GameOfThrones.quote, sender_id: rand(1..10), recipient_id: rand(1..10))
end
